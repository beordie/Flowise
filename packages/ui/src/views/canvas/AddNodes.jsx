...
const AddNodes = ({ nodesData, node, isAgentCanvas, isAgentflowv2, onFlowGenerated }) => {
    ...
    const handleOpenDialog = () => {
        ...
        setDialogProps({
            title: '你想要构建什么？',
            description:
                '输入你的提示词来生成代理流。不同模型的性能可能会有所不同。只会生成节点和边，你需要为每个节点填写输入字段。'
        })
    }
                                    ...
                                    <Box sx={{ p: 2 }}>
                                        ...
                                        {!isAgentCanvas && (
                                            <Tabs
                                                ...
                                                aria-label='tabs'
                                            >
                                                {['LangChain框架', 'LlamaIndex框架', '实用工具'].map((item, index) => (
                                                    <Tab
                                                        icon={
                                                            <div
                                                                style={{
                                                                ...
                                                                {category.split(';').length > 1 ? (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <Chip
                                                                            ...
                                                                            size='small'
                                                                            label={category.split(';')[1] === 'DEPRECATING' ? '即将弃用' : category.split(';')[1]}
                                                                        />
                                                                    </div>
                                                                ) : (
                                                                                            ...
                                                                                            >
                                                                                                ...
                                                                                                {node.badge && (
                                                                                                    <Chip
                                                                                                        ...
                                                                                                        size='small'
                                                                                                        label={node.badge === 'DEPRECATING' ? '即将弃用' : node.badge}
                                                                                                    />
                                                                                                )}
                                                                                            </div>
                                                                                            {node.author && (
